...
router.get("/editTodaysMenu",verifyToken.verifyToken("chef"),userController.editTodaysMenu)
router.get("/deleteTodaysMenu",verifyToken.verifyToken("chef"),userController.deleteTodaysMenu)
